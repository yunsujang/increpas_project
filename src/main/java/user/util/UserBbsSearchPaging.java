...
public class UserBbsSearchPaging {
	...
	public UserBbsSearchPaging(int nowPage, int rowTotal, int blockList, int blockPage,  String searchValue) {
		...
		if(isPrePage) {
			sb.append("<li><a href='search.ev?cPage=");
