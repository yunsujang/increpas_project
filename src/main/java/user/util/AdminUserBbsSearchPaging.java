...
public class AdminUserBbsSearchPaging {
	...
	public AdminUserBbsSearchPaging(int nowPage, int rowTotal, int blockList, int blockPage,  String searchValue) {
		...
		if(isPrePage) {
			sb.append("<li><a href='admin.search.ev?cPage=");
			sb.append(nowPage-blockPage);
			sb.append("&searchValue=");
			sb.append(this.searchValue);
			sb.append("'> &lt; </a></li>"); // <a href='list.ev?cPage=1'> < </a></li>
		}else
		...
		for(int i=startPage; i<=endPage; i++) {
			...
			if(i == nowPage) {
				...
				sb.append("&searchValue=");
				sb.append(this.searchValue);
				sb.append("'>"); // <a href='list.ev?cPage=1>
