...
public class categoryRecoveryPaging {
	...
	public categoryRecoveryPaging(int nowPage, int rowTotal, int blockList, int blockPage) {
		...
		if(isPrePage) {
			sb.append("<li> <a href='admin.CategoryRecovery?cPage=");
