...
<link rel="stylesheet" href="resources/css/adminevsearch.css">	
...
<body>
	...
	<div id="bbs">
		...
		<table summary="게시판 검색결과">
			<h1 id="content_title">유저 게시물 목록<br/><br/>"${searchValue }"에 대한검색결과 총'${rowTotal }'건</h1>
			<thead>	
				...
				<tr>
					<td colspan="5" >
				<input type="button" id="gobackList" value="전체글" class="c_search" onclick="javascript:location.href='admin.list.ev'"/>
					</td>				
				</tr>
