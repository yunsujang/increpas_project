...
<body>
	...
	<div id="bbs">
		...
		<div class="bbs-in-div">
			<button class="btns create-category-btn" id="makeBtn"
				onclick="makes()">게시판 생성</button>
			<button class="btns recovery-category-btn" onclick="recovery()">게시판
				복구</button>
		</div>
		<!--검색-->
		<div id="content">
			<form>
				<input type="text" id="searchValue" name="searchValue"
					class="c_search" /> <input type="button" id="searchbtn" value="검색"
					class="c_search" onclick="search()" />
			</form>
		</div>
		...
		<form id="makeForm" name="makeForm" method="post">
			<div id="makeDialog" title="게시판 생성하기">
				...
				<input type="text" id="makeName" name="makeName"
					value="${vo.evcategory_name }">

				<button type="button" id="newbtn" style="margin-left: 5px;"
					onclick="newBoard()">생성</button>
			</div>
		</form>
				...
				<c:forEach items="${cvo }" var="vo" varStatus="st">
					<tr>
						...
						<td style="cursor: pointer"
							onclick="location.href='admin.bbsList2?category_idx=${vo.evcategory_idx}'">
						...
						<td><button class="btn" id="updateBtn"
		...
		<form id="changeForm" name="changeForm" method="post">
			...
			<div id="updateDialog" title="게시판 수정하기">
				...
				<input type="hidden" id="changeIdx" name="changeIdx" value="" /> <input
					type="text" id="changeName" name="changeName" value="">

				<button type="button" id="changebtn" onclick="changeBoard()"
